...
<Appear>
  <div>
    <strong style={{fontSize: '2em'}}>Bartłomiej Bajda</strong>
  </div>
  <div>
    <strong style={{fontSize: '2em'}}>Daniel Grychtoł</strong>
  </div>
  <div>
    <strong style={{fontSize: '2em'}}>Kamil Szubrycht</strong>
  </div>
  <div>
    <strong style={{fontSize: '2em'}}>Katarzyna Tobiś</strong>
  </div>
  <div>
    <strong style={{fontSize: '2em'}}>Michał Czapkowicz</strong>
  </div>
</Appear>
...
---
  <div>
      <strong style={{fontSize: '2em'}}>Potrzebowałeś mieć stan albo efekty uboczne w komponencie Reactowym
      </strong>
  </div>
